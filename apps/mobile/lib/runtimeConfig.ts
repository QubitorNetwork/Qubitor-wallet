...
const INLINE_PUBLIC_ENV: Record<string, string | undefined> = {
  ...
  EXPO_PUBLIC_QUBITOR_INDEXER_URL: process.env.EXPO_PUBLIC_QUBITOR_INDEXER_URL,
  EXPO_PUBLIC_QUANTA_WALLET_VERSION: process.env.EXPO_PUBLIC_QUANTA_WALLET_VERSION,
};
